...
const testimonials = [
  {
    name: "רותם כהן",
    quote:
      "ארנה היא מטפלת מדהימה! הרפלקסולוגיה עזרה לי מאוד להפחית את רמות הלחץ ולשפר את איכות השינה שלי. אני ממליצה בחום לכל מי שמחפש הקלה וריפוי.",
  },
  {
    name: "מיכל לוי",
    quote:
      "הגעתי לארנה עם כאבי גב חזקים. לאחר מספר טיפולים, הכאב נעלם כליל. ארנה מקצועית, קשובה ונותנת יחס אישי. תודה רבה לך!",
  },
  {
    name: "דוד בן-דוד",
    quote:
      "לא האמנתי שרפלקסולוגיה יכולה לעזור לי, אבל גיליתי שזו טעות. ארנה עזרה לי לטפל בבעיות עיכול כרוניות שהיו לי. אני מרגיש הרבה יותר טוב עכשיו.",
  },
];
