...
export default function ContactPage() {
  ...
  return (
    <main className="contact-page">
      <Helmet>
        <title>צור קשר עם ארנה קליין - מטפלת ברפלקסולוגיה</title>
        <meta name="description" content="לתיאום טיפול ושאלות, פנו אליי דרך הטלפון, המייל או דרך פייסבוק. שעות פעילות: א'-ו' בתיאום מראש. מיקום: כפר תבור, מורן 9 ב'." />
      </Helmet>
      <h1>יצירת קשר</h1>
