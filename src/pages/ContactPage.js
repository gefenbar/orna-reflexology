  ...
  return (
    <main className="contact-page">
      ...
      <p className="some-text">
        לתיאום טיפול ולכל שאלה, אנא פנו אליי באמצעות:
      </p>
      <p className="contact-page-social">
        <a href="tel:0549794777">
          <img src="phone.webp" alt="Phone Number" width="28px" height="28px" />
          054-9794-777
        </a>
        <br />
        <br />
        <a href="mailto:orenkl162@gmail.com">
          <img src="email.webp" alt="Email Icon" width="28px" height="28px" />
          Orna Klein
        </a>
        <br />
        <br />
