        ...
        <div className="post-page-container">
            ...
            >
                ...
                <section className="post-section" id="summary">
                    ...
                    <p>
                        רפלקסולוגיה מאפשרת לך לעצור, למצוא שקט, ולתת לגוף את התמיכה שהוא צריך כדי לרפא את עצמו מבפנים. אם את מרגישה שההורמונים מנהלים אותך במקום שאת תנהלי אותם, בואי ננסה דרך אחרת.
                    </p>
                </section>
