  ...
  return (
    <div className="post-page-container">
      <div className="post-content-container">
        ...
        <div className="post-section">
          <p>על כך בפוסט הבא.... השבוע יצאתי לסיור צילום שהתמקד בהשתקפויות. למדתי שהשהייה, התבוננות בפרטים, שינויי זווית ועוד נותנים תוצאות מוצלחות ושונות. ואתן? מנסות דרכים חדשות? מוזמנות לשנות זווית ראייה להכיר אותי ואת דרכי לאיזון והרפייה</p>
